...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/examen_estructuras2021.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/examen_estructuras2021.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/examen_estructuras2021 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/examen.o: examen.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examen.o examen.c
...
${TESTDIR}/TestFiles/f3: ${TESTDIR}/tests/newcunittest4.o ${OBJECTFILES:%.o=%_nomain.o}
...
${OBJECTDIR}/examen_nomain.o: ${OBJECTDIR}/examen.o examen.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/examen.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examen_nomain.o examen.c;\
	else  \
	    ${CP} ${OBJECTDIR}/examen.o ${OBJECTDIR}/examen_nomain.o;\
	fi
